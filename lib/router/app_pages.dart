import 'package:PiliMinus/pages/about/view.dart';
import 'package:PiliMinus/pages/article/view.dart';
import 'package:PiliMinus/pages/article_list/view.dart';
import 'package:PiliMinus/pages/audio/view.dart';
import 'package:PiliMinus/pages/blacklist/view.dart';
import 'package:PiliMinus/pages/danmaku_block/view.dart';
import 'package:PiliMinus/pages/dlna/view.dart';
import 'package:PiliMinus/pages/download/view.dart';
import 'package:PiliMinus/pages/dynamics/view.dart';
import 'package:PiliMinus/pages/dynamics_create_vote/view.dart';
import 'package:PiliMinus/pages/dynamics_detail/view.dart';
import 'package:PiliMinus/pages/dynamics_topic/view.dart';
import 'package:PiliMinus/pages/dynamics_topic_rcmd/view.dart';
import 'package:PiliMinus/pages/fan/view.dart';
import 'package:PiliMinus/pages/fav/view.dart';
import 'package:PiliMinus/pages/fav_create/view.dart';
import 'package:PiliMinus/pages/fav_detail/view.dart';
import 'package:PiliMinus/pages/fav_search/view.dart';
import 'package:PiliMinus/pages/follow/view.dart';
import 'package:PiliMinus/pages/follow_search/view.dart';
import 'package:PiliMinus/pages/follow_type/follow_same/view.dart';
import 'package:PiliMinus/pages/follow_type/followed/view.dart';
import 'package:PiliMinus/pages/history/view.dart';
import 'package:PiliMinus/pages/history_search/view.dart';
import 'package:PiliMinus/pages/home/view.dart';
import 'package:PiliMinus/pages/hot/view.dart';
import 'package:PiliMinus/pages/later/view.dart';
import 'package:PiliMinus/pages/later_search/view.dart';
import 'package:PiliMinus/pages/live_dm_block/view.dart';
import 'package:PiliMinus/pages/live_room/view.dart';
import 'package:PiliMinus/pages/login/view.dart';
import 'package:PiliMinus/pages/main/view.dart';
import 'package:PiliMinus/pages/main_reply/view.dart';
import 'package:PiliMinus/pages/match_info/view.dart';
import 'package:PiliMinus/pages/member/view.dart';
import 'package:PiliMinus/pages/member_dynamics/view.dart';
import 'package:PiliMinus/pages/member_profile/view.dart';
import 'package:PiliMinus/pages/member_search/view.dart';
import 'package:PiliMinus/pages/member_upower_rank/view.dart';
import 'package:PiliMinus/pages/msg_feed_top/at_me/view.dart';
import 'package:PiliMinus/pages/msg_feed_top/like_detail/view.dart';
import 'package:PiliMinus/pages/msg_feed_top/like_me/view.dart';
import 'package:PiliMinus/pages/msg_feed_top/reply_me/view.dart';
import 'package:PiliMinus/pages/msg_feed_top/sys_msg/view.dart';
import 'package:PiliMinus/pages/music/view.dart';
...
import 'package:PiliMinus/pages/setting/pages/bar_set.dart';
import 'package:PiliMinus/pages/setting/pages/color_select.dart';
import 'package:PiliMinus/pages/setting/pages/display_mode.dart';
import 'package:PiliMinus/pages/setting/pages/font_size_select.dart';
import 'package:PiliMinus/pages/setting/pages/logs.dart';
import 'package:PiliMinus/pages/setting/pages/play_speed_set.dart';
import 'package:PiliMinus/pages/setting/play_setting.dart';
import 'package:PiliMinus/pages/setting/privacy_setting.dart';
import 'package:PiliMinus/pages/setting/recommend_setting.dart';
import 'package:PiliMinus/pages/setting/style_setting.dart';
import 'package:PiliMinus/pages/setting/video_setting.dart';
import 'package:PiliMinus/pages/setting/view.dart';
import 'package:PiliMinus/pages/settings_search/view.dart';
import 'package:PiliMinus/pages/space_setting/view.dart';
import 'package:PiliMinus/pages/sponsor_block/view.dart';
import 'package:PiliMinus/pages/subscription/view.dart';
import 'package:PiliMinus/pages/subscription_detail/view.dart';
import 'package:PiliMinus/pages/video/view.dart';
import 'package:PiliMinus/pages/webdav/view.dart';
import 'package:PiliMinus/pages/webview/view.dart';
import 'package:PiliMinus/pages/whisper/view.dart';
import 'package:PiliMinus/pages/whisper_detail/view.dart';
